...
class TransaksiController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('createRevenue','update'),
				'users'=>array('@'),
			),
	 ...
	 */
	public function actionCreateRevenue()
	{
		$model=new InputRevenueForm();
        ...
        $model->koper = Yii::app()->params['koper']['omset']['debit'];
		$this->render('createRevenue',array(
			'model'=>$model,
		));
	}
