          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row portfolio text-center color-white">
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/portfolio-1.jpg" alt="" class="img-fluid">
                ...
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/portfolio-2.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
                ...
                <div class="col-md-4">
                  <div class="box-image">
                    <div class="image"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/portfolio-3.jpg" alt="" class="img-fluid">
                      <div class="overlay d-flex align-items-center justify-content-center">
                        <div class="content">
                          <div class="name">
                            <h3><a href="portfolio-detail.html" class="color-white">Portfolio item</a></h3>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <ul class="list-unstyled owl-carousel customers no-mb">
                <li class="item"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/customer-1.png" alt="" class="img-fluid"></li>
                <li class="item"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/customer-2.png" alt="" class="img-fluid"></li>
                <li class="item"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/customer-3.png" alt="" class="img-fluid"></li>
                <li class="item"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/customer-4.png" alt="" class="img-fluid"></li>
                <li class="item"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/customer-5.png" alt="" class="img-fluid"></li>
                <li class="item"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/customer-6.png" alt="" class="img-fluid"></li>
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-3">
                <div class="home-blog-post">
                  <div class="image"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/portfolio-4.jpg" alt="..." class="img-fluid">
              ...
              <div class="col-lg-3">
                <div class="home-blog-post">
                  <div class="image"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/portfolio-5.jpg" alt="..." class="img-fluid">
                    <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                  </div>
                  <div class="text">
              ...
              <div class="col-lg-3">
                <div class="home-blog-post">
                  <div class="image"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/portfolio-6.jpg" alt="..." class="img-fluid">
                    <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                  </div>
                  <div class="text">
                    <h4><a href="#">Fashion Now </a></h4>
