...
<div class="top-bar">
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="<?php echo Yii::app()->request->baseUrl ?>" class="navbar-brand home"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/logo-mfg.png" alt="Mode Fashion Group" class="d-none d-md-inline-block"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/assets2/img/logo-mfg.png" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
